                ...
                <table class="table table-hover table-bordered">
                    ...
                    <tbody id="level-list">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control" value="<?php  echo $_W['siteroot'];?>app/index.php?i=<?php  echo $_W['uniacid'];?>&c=entry&storeid=<?php  echo $storeid;?>&mode=2&cateid=<?php  echo $row['id'];?>&do=waplist&m=weisrc_dish">
