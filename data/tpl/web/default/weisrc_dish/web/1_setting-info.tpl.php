<?php defined('IN_IA') or exit('Access Denied');?><div class="tab-pane" id="tab_info">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">优惠券办理成功通知模版ID</label>
                <div class="col-sm-9">
                    <input type="text" name="tplcoupon" class="form-control" value="<?php  echo $setting['tplcoupon'];?>" />
                    <div class="help-block">IT科技行业在模板库选择行业<code>IT科技－互联网|电子商务</code>，搜索“办理成功通知”编号为<code>OPENTM409797795</code>的模板</div>
                </div>
            </div>
            <div class="form-group">
