...
class Core extends WeModuleSite
{
    ...
    public $table_tableorder = "weisrc_dish_tableorder";
    ...
    public $table_cardlist = "weisrc_dish_cardlist";
    public $table_cardrecord = "weisrc_dish_cardrecord";
...
//        $cur_color = ' style="color:#d9534f;" ';
        ...
        $navemenu[] = array(
            ...
            'items' => array(
                ...
                4 => $this->createSubMenu('会员卡管理', $do, 'cardlist', 'fa-angle-right', $cur_color, $storeid),
                5 => $this->createSubMenu('评论管理 ', $do, 'feedback', 'fa-angle-right', $cur_color, $storeid),
                6 => $this->createSubMenu('配送区域 ', $do, 'dispatcharea', 'fa-angle-right', $cur_color, $storeid),
            )
        );
        $cur_color = '#8d8d8d';
        $navemenu[] = array(
            ...
            'items' => array(
                ...
                1 => $this->createSubMenu('清桌记录 ', $do, 'tableorder', 'fa-angle-right', $cur_color, $storeid),
                2 => $this->createSubMenu('餐桌类型 ', $do, 'tablezones', 'fa-angle-right', $cur_color, $storeid),
                3 => $this->createSubMenu('排队管理 ', $do, 'queueorder', 'fa-angle-right', $cur_color, $storeid),
                4 => $this->createSubMenu('预订管理 ', $do, 'reservation', 'fa-angle-right', $cur_color, $storeid),
                5 => $this->createSubMenu('营销管理 ', $do, 'coupon', 'fa-angle-right', $cur_color, $storeid),
            )
        );
